Feature: Facilities Management - Search Results - Search - Create
  ...
  Scenario: FM - Results - General Content
    Then I am on "Quick view results" page
    And the "up to 7m" lot is displayed            
    And the "between 7m and 50m" lot is displayed
    And the "over 50m" lot is displayed
    And the following heading text is displayed:
      | Sub-lot 1a              |
      | Sub-lot 1b              |
      | Sub-lot 1c              |
