Feature: Security services service hour questions
  ...
  Examples:
    | service                               | page_title                            |
    | Manned guarding service               | Manned guarding service               |
    | CCTV / alarm monitoring               | Cctv / alarm monitoring               |
    | Control of access and security passes | Control of access and security passes |
    | Emergency response                    | Emergency response                    |
    | Patrols (fixed or static guarding)    | Patrols (fixed or static guarding)    |
    | Management of visitors and passes     | Management of visitors and passes     |