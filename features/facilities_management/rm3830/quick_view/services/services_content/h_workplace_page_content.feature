Feature:  Facilities Management - Services - Workplace FM - Page Content
  ...
  Scenario: FM - Services - Workplace FM Services - Content
    ...
    Then the following "Workplace FM services" are displayed:
      | Handyman services                           |
    ...
    Then the following descriptions for "Workplace FM services" are displayed:
    ...
    When I select all "Workplace FM services"
