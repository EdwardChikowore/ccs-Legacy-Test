Feature:Manage Building
  ...
  Scenario: Building type - Validation error
    ...
    When I click on view more building types
  ...
  Scenario Outline: Building details Summary - Change link
  ...
  Examples:
    ...
    | Gross internal area | Internal and external areas |
    | External area       | Internal and external areas |
