...
#    And I should see my selection in the region basket
    ...
    And I select first building "Aberdeen" with address "259 Yardley Green Road, Bordesley Green, Birmingham, West Midlands, B9 5QA"
    ...
    And I click on "Back to detailed search summary"
    And I click on "Continue"
    And I should see the price displayed £213,142.21
    And I click on the Direct award route to market
    And I click on "Continue"
    And the lowest priced supplier is "Wolf-Wiza" and contract price is £213,142.21
    And the second subsequent supplier is "Supplier 2" and contract price is £236,737.49
    And the third subsequent supplier is "Supplier 3" and contract price is £238,223.83
    And the fourth subsequent supplier is "Supplier 4" and contract price is £240,069.52
    And the fifth subsequent supplier is "Supplier 5" and contract price is £242,152.90
    And the sixth subsequent supplier is "Supplier 6" and contract price is £246,940.94
    And the seventh subsequent supplier is "Supplier 7" and contract price is £253,629.64
    And the eighth subsequent supplier is "Supplier 8" and contract price is £256,361.94
    And the ninth subsequent supplier is "Supplier 9" and contract price is £267,376.60
    And the tenth subsequent supplier is "Supplier 10" and contract price is £273,287.99
    ...
    And I click on the question for "Invoicing contact details"
