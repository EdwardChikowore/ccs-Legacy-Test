...
Then(/^The direct award option should not be displayed$/) do
  expect(common.market_route).to have_no_radio_items[0]
  expect(common.market_route).to have_no_radio_items[1]
  expect(common.market_route).to have_no_radio_items[2]
