Feature:Fire detection and firefighting systems maintenance
  ...
  Scenario: Selecting building service standards
    ...
    When I select standard C
    And I click on "Save and return"
    Then I am on the "Service requirements" page
    And I click on service standards change link
    Then I am on the "Fire detection and firefighting systems maintenance" page
