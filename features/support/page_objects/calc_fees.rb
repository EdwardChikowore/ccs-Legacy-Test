...
#element :perm_fee, '#main-content > div.govuk-body > div:nth-child(1) > div > div > div > strong'
#element :perm_fee, '#main-content > div.govuk-body > div:nth-child(1) > div > div > div > br'
